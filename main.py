...
class DiskCleanerApp(QMainWindow):
    ...
    def create_deep_clean_ui(self):
        ...
        if hasattr(self, 'force_mode_activated') and self.force_mode_activated:
            self.deep_dev_mode_label.setText("强力模式: <span style='color: green; font-weight: bold;'>已激活</span>")
        else:
        ...
        self.force_mode_check.setEnabled(hasattr(self, 'force_mode_activated') and self.force_mode_activated)
        self.force_mode_check.setChecked(hasattr(self, 'force_mode_activated') and self.force_mode_activated)
